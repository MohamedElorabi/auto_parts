        ...
        <div class="col-md-6 col-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form class="form form-vertical" action="{{route('company_sector_specialist.update', $company_sector->id)}}" method="POST">
                            {{ csrf_field() }}
                            {{ method_field('PUT') }}
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label>اسم قطاع الشركة</label>
                                            <input type="text" name="name" class="form-control" value="{{$company_sector->name}}">
                                        </div>
                                    </div>
